...
export const QueryBlockProvisionsResponse = {
  ...
  fromJSON(object: any): QueryBlockProvisionsResponse {
    return {
      blockProvisions: isSet(object.blockProvisions) ? bytesFromBase64(object.blockProvisions) : new Uint8Array()
    };
  },
  toJSON(message: QueryBlockProvisionsResponse): unknown {
    const obj: any = {};
    message.blockProvisions !== undefined && (obj.blockProvisions = base64FromBytes(message.blockProvisions !== undefined ? message.blockProvisions : new Uint8Array()));
    return obj;
  },
