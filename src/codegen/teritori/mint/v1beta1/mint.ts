...
export const Minter = {
  ...
  fromJSON(object: any): Minter {
    return {
      blockProvisions: isSet(object.blockProvisions) ? String(object.blockProvisions) : ""
    };
  },
  toJSON(message: Minter): unknown {
    const obj: any = {};
    message.blockProvisions !== undefined && (obj.blockProvisions = message.blockProvisions);
    return obj;
  },
...
export const TeamVestingMonthInfo = {
  ...
  fromJSON(object: any): TeamVestingMonthInfo {
    return {
      monthsSinceGenesis: isSet(object.monthsSinceGenesis) ? Long.fromValue(object.monthsSinceGenesis) : Long.ZERO,
      monthStartedBlock: isSet(object.monthStartedBlock) ? Long.fromValue(object.monthStartedBlock) : Long.ZERO,
      oneMonthPeriodInBlocks: isSet(object.oneMonthPeriodInBlocks) ? Long.fromValue(object.oneMonthPeriodInBlocks) : Long.ZERO
    };
  },
  toJSON(message: TeamVestingMonthInfo): unknown {
    const obj: any = {};
    message.monthsSinceGenesis !== undefined && (obj.monthsSinceGenesis = (message.monthsSinceGenesis || Long.ZERO).toString());
    message.monthStartedBlock !== undefined && (obj.monthStartedBlock = (message.monthStartedBlock || Long.ZERO).toString());
    message.oneMonthPeriodInBlocks !== undefined && (obj.oneMonthPeriodInBlocks = (message.oneMonthPeriodInBlocks || Long.ZERO).toString());
    return obj;
  },
...
export const MonthlyVestingAddress = {
  ...
  fromJSON(object: any): MonthlyVestingAddress {
    return {
      ...
      monthlyAmounts: Array.isArray(object?.monthlyAmounts) ? object.monthlyAmounts.map((e: any) => String(e)) : []
    };
  },
  toJSON(message: MonthlyVestingAddress): unknown {
    const obj: any = {};
    message.address !== undefined && (obj.address = message.address);
    if (message.monthlyAmounts) {
      obj.monthlyAmounts = message.monthlyAmounts.map(e => e);
    } else {
      obj.monthlyAmounts = [];
    }
    return obj;
...
export const DistributionProportions = {
  ...
  fromJSON(object: any): DistributionProportions {
    return {
      grantsProgram: isSet(object.grantsProgram) ? String(object.grantsProgram) : "",
      communityPool: isSet(object.communityPool) ? String(object.communityPool) : "",
      usageIncentive: isSet(object.usageIncentive) ? String(object.usageIncentive) : "",
  ...
  toJSON(message: DistributionProportions): unknown {
    const obj: any = {};
    message.grantsProgram !== undefined && (obj.grantsProgram = message.grantsProgram);
    message.communityPool !== undefined && (obj.communityPool = message.communityPool);
    message.usageIncentive !== undefined && (obj.usageIncentive = message.usageIncentive);
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    return {
      ...
      genesisBlockProvisions: isSet(object.genesisBlockProvisions) ? String(object.genesisBlockProvisions) : "",
      reductionPeriodInBlocks: isSet(object.reductionPeriodInBlocks) ? Long.fromValue(object.reductionPeriodInBlocks) : Long.ZERO,
      ...
      weightedDeveloperRewardsReceivers: Array.isArray(object?.weightedDeveloperRewardsReceivers) ? object.weightedDeveloperRewardsReceivers.map((e: any) => MonthlyVestingAddress.fromJSON(e)) : [],
      usageIncentiveAddress: isSet(object.usageIncentiveAddress) ? String(object.usageIncentiveAddress) : "",
      grantsProgramAddress: isSet(object.grantsProgramAddress) ? String(object.grantsProgramAddress) : "",
      teamReserveAddress: isSet(object.teamReserveAddress) ? String(object.teamReserveAddress) : "",
      mintingRewardsDistributionStartBlock: isSet(object.mintingRewardsDistributionStartBlock) ? Long.fromValue(object.mintingRewardsDistributionStartBlock) : Long.ZERO
    };
  },
  toJSON(message: Params): unknown {
    const obj: any = {};
    message.mintDenom !== undefined && (obj.mintDenom = message.mintDenom);
    message.genesisBlockProvisions !== undefined && (obj.genesisBlockProvisions = message.genesisBlockProvisions);
    message.reductionPeriodInBlocks !== undefined && (obj.reductionPeriodInBlocks = (message.reductionPeriodInBlocks || Long.ZERO).toString());
    ...
    if (message.weightedDeveloperRewardsReceivers) {
      obj.weightedDeveloperRewardsReceivers = message.weightedDeveloperRewardsReceivers.map(e => e ? MonthlyVestingAddress.toJSON(e) : undefined);
    } else {
      obj.weightedDeveloperRewardsReceivers = [];
    }
    message.usageIncentiveAddress !== undefined && (obj.usageIncentiveAddress = message.usageIncentiveAddress);
    message.grantsProgramAddress !== undefined && (obj.grantsProgramAddress = message.grantsProgramAddress);
    message.teamReserveAddress !== undefined && (obj.teamReserveAddress = message.teamReserveAddress);
    message.mintingRewardsDistributionStartBlock !== undefined && (obj.mintingRewardsDistributionStartBlock = (message.mintingRewardsDistributionStartBlock || Long.ZERO).toString());
    return obj;
  },
